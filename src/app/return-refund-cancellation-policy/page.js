  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen">
      <div className="max-w-5xl mx-auto px-6 pt-24 pb-20">
          ...
          <div className="lg:col-span-9 space-y-24">
            ...
            <section id="returns" className="scroll-mt-32">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-2xl font-light tracking-tight text-neutral-900">Return Policy</h2>
              </div>
              
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-8 bg-white border border-neutral-100 rounded-[2rem]">
                    <h3 className="text-[11px] font-bold text-black uppercase tracking-widest mb-4 flex items-center gap-2">
                  ...
                  <div className="p-8 bg-neutral-900 text-white rounded-[2rem]">
            ...
            <section id="refunds" className="scroll-mt-32">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-2xl font-light tracking-tight text-neutral-900">Refund Guidelines</h2>
              </div>

              <div className="bg-white border border-neutral-200 rounded-[2.5rem] overflow-hidden">
                <div className="p-10 border-b border-neutral-100">
                  <h3 className="text-lg font-medium mb-4 text-black italic">The Unboxing Requirement</h3>
                ...
                <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-widest text-neutral-400 mb-4">Refund Timelines</h4>
                    <ul className="space-y-4 text-sm font-light text-neutral-700">
                  ...
                  <div>
                    <h4 className="text-[11px] font-bold uppercase tracking-widest text-neutral-400 mb-4">Contact for Claims</h4>
                    <p className="text-sm font-medium text-black mb-1">+91 99300 63303</p>
                    <p className="text-sm font-light text-neutral-600 mb-4">support@nha-world.com</p>
            ...
            <section id="cancellation" className="scroll-mt-32">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-2xl font-light tracking-tight text-neutral-900">Cancellation Policy</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-neutral-400">Pre-Dispatch</h4>
                ...
                <div className="space-y-4">
                  <h4 className="text-[11px] font-bold uppercase tracking-[0.2em] text-neutral-400">Post-Dispatch</h4>
                  <p className="text-sm font-light text-neutral-600 leading-relaxed">
        ...
        {/* Support Footer */}
        <footer className="mt-32 pt-16 border-t border-neutral-200">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
            <div>
              <p className="text-[10px] font-bold tracking-[0.2em] text-neutral-400 uppercase mb-2">Still Have Questions?</p>
              <h4 className="text-xl font-light text-neutral-900">We are here to help you.</h4>
            </div>
            <button className="px-10 py-4 cursor-pointer bg-black text-white text-[10px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-neutral-800 transition-all">
              Contact Concierge
            </button>
          </div>
        </footer>
