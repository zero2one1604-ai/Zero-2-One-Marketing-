  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen">
      <div className="max-w-4xl mx-auto px-6 pt-10 md:pt-24 pb-10 md:pb-20">
        ...
        <div className= "mb-5 md:mb-20 p-6 md:p-12 bg-white border border-neutral-200 rounded-[3rem] text-center shadow-sm">
          <AlertCircle className="w-6 h-6 text-neutral-900 mx-auto mb-2 md:mb-6" />
          <p className="text-sm md:text-xl font-light text-neutral-900 leading-relaxed italic">
        ...
        <div className="space-y-6 md:space-y-16">
          ...
          <section className="flex flex-col md:flex-row gap-2 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h2 className="text-[11px] font-bold uppercase tracking-widest text-neutral-900 mt-1 md:mt-2">Acceptance</h2>
            </div>
          ...
          <section className="flex flex-col md:flex-row gap-2 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h2 className="text-[11px] font-bold uppercase tracking-widest text-neutral-900 mt-1 md:mt-2">Product Usage</h2>
            </div>
            <div className="md:w-3/4">
              <p className="text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
          ...
          <section className="flex flex-col md:flex-row gap-2 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h2 className="text-[11px] font-bold uppercase tracking-widest text-neutral-900 mt-1 md:mt-2">Liability</h2>
            </div>
            <div className="md:w-3/4">
              <p className="text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
          ...
          <section className="flex flex-col md:flex-row gap-2 md:gap-8">
            <div className="md:w-1/4">
              ...
              <h2 className="text-[11px] font-bold uppercase tracking-widest text-neutral-900 mt-1 md:mt-2">Force Majeure</h2>
            </div>
            <div className="md:w-3/4">
              <p className="text-xs md:text-sm text-neutral-600 font-light leading-relaxed">
          ...
          <section className="p-8 md:p-12 bg-neutral-900 rounded-[2.5rem] text-white">
            <div className="flex items-center gap-4 mb-5 md:mb-8">
              <Globe className="md:w-5 md:h-5 text-neutral-400" />
              <h2 className="text-[10px] md:text-[11px] font-bold uppercase tracking-[0.3em]">Governing Law & Jurisdiction</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
              <div className="space-y-2 md:space-y-4">
                <h3 className="text-neutral-400 text-[10px] font-bold uppercase">Primary Law</h3>
                <p className="text-xs md:text-sm font-light leading-relaxed text-neutral-200">
