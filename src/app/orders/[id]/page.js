...
export default function OrderStatusPage() {
  ...
  return (
    <>
    <div className="min-h-screen bg-[#FAF9F6] py-24 px-6 flex flex-col items-center justify-center">
      <AnimatePresence mode="wait">
        {order.status === 'paid' ? (
          ...
          >
            ...
            <div className="bg-white rounded-[3rem] p-10 md:p-16 text-center shadow-[0_30px_100px_-20px_rgba(0,0,0,0.04)] border border-neutral-100 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl font-light text-neutral-900 tracking-tight uppercase mb-6">
                  Payment <br /> <span className="font-serif italic text-neutral-400">Successful</span>
                </h1>

                <p className="text-sm text-neutral-500 font-light leading-relaxed max-w-xs mx-auto mb-10">
                  Your order has been received and is now being prepared in our laboratory.
                </p>

                <div className="bg-neutral-50 rounded-3xl p-8 mb-10 flex flex-col md:flex-row justify-between items-center gap-6">
                  <div className="text-center md:text-left">
                    <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest mb-1">Order Identifier</p>
                    <p className="text-sm font-medium text-neutral-900">#{order.id.slice(0, 8).toUpperCase()}</p>
                  </div>
                  ...
                  <div className="text-center md:text-right">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-sm font-medium text-neutral-900 uppercase tracking-tighter">Processed</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-center justify-center gap-4">
                  <Link
                    href="/shop"
                    className="w-full sm:w-auto px-10 py-4 bg-black text-white text-[10px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-neutral-800 transition-all active:scale-95 flex items-center justify-center gap-3"
                  >
                    <ShoppingBag className="w-4 h-4" /> Continue Discovery
                  </Link>
                  <Link
                    href="/account"
            ...
            <p className="mt-12 text-center text-[10px] text-neutral-400 font-light uppercase tracking-widest leading-relaxed">
          ...
          >
            <Loader2 className="w-16 h-16 animate-spin mx-auto mb-8 text-neutral-200" />
            <h2 className="text-2xl font-light text-neutral-900 mb-2 tracking-tight">Synchronizing Payment</h2>
            <p className="text-sm text-neutral-500 font-light italic">Please remain on this page while we verify your transaction...</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
