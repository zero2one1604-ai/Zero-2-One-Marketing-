      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0e1a] via-[#0f1629] to-[#1a1f3a]">
        ...
        <header className="relative overflow-hidden border-b border-amber-200/10">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32 text-center">
            ...
            <h1 className="text-2xl md:text-5xl the-seasons lg:text-6xl xl:text-7xl font-light text-white tracking-[0.15em] sm:tracking-[0.2em] md:tracking-[0.25em] uppercase mb-4 sm:mb-6">
              Our Story
            </h1>
            
            <p className="text-sm md:text-2xl text-amber-100/80 font-light leading-relaxed max-w-3xl mx-auto italic px-20 md:px-4">
                ...
                <div className='flex flex-col'>
                  <div className="inline-block mb-2 md:mb-4 mx-auto md:mx-0 sm:mb-6">
                    <div className="flex items-center gap-2 sm:gap-3">
                      ...
                      <span className="text-amber-300 text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase font-medium">Brand Story</span>
                    </div>
                  </div>
                  
                  <h2 className="text-lg text-center md:text-left md:text-4xl font-light text-white tracking-wide mb-4 sm:mb-6">
                    A Journey Born from <span className="text-amber-400">Love</span>
                  </h2>
                </div>

                <div className="space-y-4 sm:space-y-6 text-amber-100/80 leading-relaxed font-light text-justify text-base sm:text-lg">
                  <p>
...
friendly and safe to be used by the whole family. </p>
                ...
                <div className="pt-4 sm:pt-6">
                  <div className="inline-flex items-center gap-2 sm:gap-3 px-2 sm:px-6 py-1 sm:py-3 bg-amber-500/10 border border-amber-500/30 rounded-full">
                    <Shield className="w-3 h-3 sm:w-5 sm:h-5 text-amber-400 flex-shrink-0" />
                    <span className="text-amber-300 text-[8px] sm:text-sm tracking-wider uppercase font-medium">
          ...
          <section className="py-12 sm:py-16 md:py-20 lg:py-24 border-t border-amber-200/10">
            <div className="text-center mb-4 sm:mb-16">
              <div className="inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <Globe className="w-5 h-5 sm:w-6 sm:h-6 text-amber-400" />
                <span className="text-amber-300 text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase font-medium">Our Mission</span>
              </div>
              
              <h2 className="text-2xl the-seasons sm:text-4xl md:text-5xl font-light text-white tracking-[0.15em] sm:tracking-[0.2em] uppercase md:mb-6 sm:mb-8 px-4">
                Going Global
              </h2>
              
              <p className="text-xs sm:text-lg md:text-xl text-amber-100/80 font-light leading-relaxed max-w-4xl mx-auto px-4">
            ...
            <div className="bg-gradient-to-br from-[#1a2540]/80 to-[#0f1629]/80 backdrop-blur-xl rounded-2xl p-6 sm:p-8 md:p-10 lg:p-12 border border-amber-200/10 shadow-2xl">
              <div className="grid grid-cols-3 sm:gap-8 text-center">
                <div className="space-y-3 sm:space-y-4">
                  <div className="w-12 h-12 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-amber-600 to-amber-500 flex items-center justify-center mx-auto shadow-lg">
                    <Globe className="w-6 h-6 sm:w-10 sm:h-10 text-white" />
                  </div>
                  <div>
                    <div className="text-lg sm:text-4xl md:text-5xl font-light text-amber-400 md:mb-2">45+</div>
                    <p className="text-amber-100/70 tracking-wider uppercase text-[8px] sm:text-sm">Countries Served</p>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div>
                    <div className="text-lg sm:text-4xl md:text-5xl font-light text-amber-400 md:mb-2">50K+</div>
                    <p className="text-amber-100/70 tracking-wider uppercase text-[8px] sm:text-sm">Happy Families</p>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div>
                    <div className="text-lg sm:text-4xl md:text-5xl font-light text-amber-400 md:mb-2">100+</div>
                    <p className="text-amber-100/70 tracking-wider uppercase text-[8px] sm:text-sm">Countries by 2030</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="py-12 sm:py-16 md:py-20 lg:py-24 border-t border-amber-200/10">
            <div className="text-center mb-12 sm:mb-16">
              <div className="inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                ...
                <span className="text-amber-300 text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase font-medium">Our Values</span>
              </div>
              
              <h2 className="text-2xl the-seasons sm:text-4xl md:text-5xl font-light text-white tracking-[0.15em] sm:tracking-[0.2em] uppercase sm:mb-8 px-4">
                What We Stand For
              </h2>
              
              <p className="text-xs sm:text-lg md:text-xl text-amber-100/80 font-light leading-relaxed max-w-3xl mx-auto px-4">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-6 lg:gap-8">
              {values.map((value, index) => (
                <article
                  ...
                  className={`group p-3 sm:p-8 bg-gradient-to-b from-[#1a2540]/60 to-[#0f1629]/60 backdrop-blur-md rounded-2xl border transition-all duration-500 hover:scale-[1.02] cursor-pointer ${
                    activeValue === index
                ...
                >
                  ...
                  <h3 className="text-white text-sm sm:text-xl font-medium mb-2 sm:mb-3 tracking-wide">
                    {value.title}
                  </h3>
                  
                  <p className="text-amber-100/70 font-light leading-relaxed text-xs sm:text-base">
                    {value.description}
                  </p>
                </article>
              ))}
          ...
          <section className="py-12 sm:py-16 md:py-20 lg:py-24 border-t border-amber-200/10">
            <div className="text-center mb-8 sm:mb-16">
              <h2 className="text-2xl the-seasons sm:text-4xl md:text-5xl font-light text-white tracking-[0.15em] sm:tracking-[0.2em] uppercase mb-6 sm:mb-8 px-4">
                Our Journey
              </h2>
            </div>
                  ...
                  {timeline.map((item, index) => (
                    <div key={index} className={`flex items-center gap-6 lg:gap-8 ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}>
                      <div className={`flex-1 ${index % 2 === 0 ? 'text-right' : 'text-left'}`}>
                        <div className="inline-block bg-gradient-to-b from-[#1a2540] to-[#0f1629] p-4 sm:p-6 rounded-xl border border-amber-200/10 hover:border-amber-500/30 transition-all duration-300 hover:scale-[1.02]">
                          <time className="text-2xl sm:text-3xl font-light text-amber-400 mb-2 block">{item.year}</time>
                          <h3 className="text-white text-base sm:text-lg font-medium mb-2">{item.event}</h3>
                          <p className="text-amber-100/70 text-sm font-light">{item.description}</p>
                        </div>
                      </div>
                      <div className="relative z-10">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-gradient-to-br from-amber-600 to-amber-500 border-4 border-[#0f1629] shadow-lg" />
                      </div>
              ...
              <div className="md:hidden space-y-4">
                {timeline.map((item, index) => (
                  <div key={index} className="relative pl-8">
                    <div className="absolute left-0 top-0 w-5 h-5 rounded-full bg-gradient-to-br from-amber-600 to-amber-500 border-4 border-[#0f1629] shadow-lg" />
                    {index < timeline.length - 1 && (
                      <div className="absolute left-2.5 top-5 w-px h-full bg-amber-500/50" />
                    )}
                    <div className="bg-gradient-to-b from-[#1a2540] to-[#0f1629] p-4 rounded-xl border border-amber-200/10">
                      <time className="text-lg font-light text-amber-400 mb-2 block">{item.year}</time>
                      <h3 className="text-white text-sm font-medium mb-2">{item.event}</h3>
                      <p className="text-amber-100/70 text-xs font-light">{item.description}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="sm:space-y-8 order-2 lg:order-1">
                <div className='flex flex-col'>
                  <div className="inline-flex items-center mx-auto gap-2 sm:gap-3 mb-4 sm:mb-6">
                    ...
                    <span className="text-green-300 text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase font-medium">Sustainability</span>
                  </div>
                  
                  <h2 className="text-2xl the-seasons text-center sm:text-3xl md:text-4xl font-light text-white tracking-wide mb-4 sm:mb-6">
                    Our Commitment to the <span className="text-green-400">Planet</span>
                  </h2>
                </div>

                <div className="space-y-4 sm:space-y-6 text-amber-100/80 leading-relaxed font-light text-sm sm:text-lg">
                  <p>
                ...
                <div className="space-y-3 sm:space-y-4 pt-4">
                  {[
                    ...
                    <div key={index} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 p-3 sm:p-4 bg-white/5 rounded-lg border border-green-500/20 hover:border-green-500/40 transition-all duration-300">
                      <span className="text-white font-light text-sm sm:text-base">{item.label}</span>
                      <span className="text-green-400 text-xs sm:text-sm tracking-wider uppercase font-medium">{item.status}</span>
                    </div>
                  ))}
                </div>
              </div>
